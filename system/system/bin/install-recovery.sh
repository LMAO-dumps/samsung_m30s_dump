#!/system/bin/sh
if ! applypatch --check EMMC:/dev/block/by-name/recovery$(getprop ro.boot.slot_suffix):67633152:2fa31a6093827f8fc1b5f1f1f68db80ae5a92d88; then
  applypatch \
          --patch /system/recovery-from-boot.p \
          --source EMMC:/dev/block/by-name/boot$(getprop ro.boot.slot_suffix):57671680:17cba032dca9400758d0a1698ebeeb0c63e44411 \
          --target EMMC:/dev/block/by-name/recovery$(getprop ro.boot.slot_suffix):67633152:2fa31a6093827f8fc1b5f1f1f68db80ae5a92d88 && \
