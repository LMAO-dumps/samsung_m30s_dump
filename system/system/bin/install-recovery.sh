#!/system/bin/sh
if ! applypatch --check EMMC:/dev/block/by-name/recovery$(getprop ro.boot.slot_suffix):67633152:58d4b902fc2e4bbaadd8e93917a1d139173eee28; then
  applypatch \
          --patch /system/recovery-from-boot.p \
          --source EMMC:/dev/block/by-name/boot$(getprop ro.boot.slot_suffix):57671680:9ef624e97488e003c7ca39e6d4f5319a7499dbe8 \
          --target EMMC:/dev/block/by-name/recovery$(getprop ro.boot.slot_suffix):67633152:58d4b902fc2e4bbaadd8e93917a1d139173eee28 && \
