...
cat system/system/app/Maps/Maps.apk.* 2>/dev/null >> system/system/app/Maps/Maps.apk
rm -f system/system/app/Maps/Maps.apk.* 2>/dev/null
...
cat product/app/YandexSearchforAndroid11/YandexSearchforAndroid11.apk.* 2>/dev/null >> product/app/YandexSearchforAndroid11/YandexSearchforAndroid11.apk
rm -f product/app/YandexSearchforAndroid11/YandexSearchforAndroid11.apk.* 2>/dev/null
